...
#define BT_DEFAULT_VOLUME 27 // громкость устанавливаемая по умолчанию; значение громкости = гр-ть в процентах *1.27
...
//        channelBtSetAttr(rc->meta_rsp.attr_id,(char *) rc->meta_rsp.attr_text);
        evt.code = MY_EVENT_BT_ATTR;
            evt.param = rc->meta_rsp.attr_id;
        xQueueSend(mainQ, (void *)&evt,10);
