...
This is a sketch to quickly program the I2C EEPROM on the Audio DSP board. 

0. Добавьте в Arduino библиотеки EEPROM24, I2CMaster & SoftI2C.

1. Загрузите скетч в Arduino.

2. Соедините выводы Arduino Uno или Mega с аудиопроцессором:
...
3. Загрузите E2Prom.hex файл сгенерированый SigmaStudio в  
   Arduino. Скорость передачи com порта 19200 baud. 
   DSP должен быть подключен.
...
void setup(void)
{
  ...
  Serial.println("Audio DSP Board");
